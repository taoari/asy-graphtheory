...
defaultcircuitlightstyle=symbolstyle(textpen=red+fontcommand("\ttfamily"), filler=Filler(yellow), indrawer=red, outdrawer=red);
defaultcircuitbatterystyle=symbolstyle(textpen=blue+fontcommand("\ttfamily"), indrawer=InDrawer(blue,1,3));
defaultcircuitswitchstyle=symbolstyle(textpen=green+fontcommand("\ttfamily"), indrawer=green);
...
real u=2cm;
real v=2cm;
l1 << eright(u) << b1 << eright(u) << s1 << eright(u) << new node << edown(v) 
    << l2 << edown(v) << b2 << edown(v) << s2 << edown(v) << new node << eleft(u) 
    << l3 << eleft(u) << b3 << eleft(u) << s3 << eleft(u) << new node << eup(v) 
    << l4 << eup(v) << b4 << eup(v) << s4 << eup(u);
