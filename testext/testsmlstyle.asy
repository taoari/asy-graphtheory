...
defaultnodestyle=nodestyle(mag=1.4, drawfn=FillDrawer(cyan, red));
...
defaultsmlactorstyle=symbolstyle(xmargin=0.1cm, ymargin=0.2cm, textpen=red, filler=Filler(yellow), indrawer=Drawer(green), outdrawer=DoubleDrawer(blue, white));

node a=sml_actor("Programmer");//sbox("Programmer");
